export default function AuthButton({ user, loading, onLoginGithub, onLoginGoogle, onLogout }) {
  if (loading) {
  ...
  return (
    <div>
      <div className="text-[10px] text-text-secondary mb-1.5">Sign in</div>
      <div className="flex gap-1.5">
        <button
          onClick={onLoginGithub}
          className="flex-1 flex items-center justify-center gap-1.5 px-2 py-1.5 text-[11px] text-text-secondary
            hover:text-text-primary bg-bg-card hover:bg-bg-primary rounded-lg transition-colors"
        >
